...
perl $COMPAREFOLDER/scripts/orthomcl_to_table.pl -r $PROJECT.I${INFLATION}.ortholog_counts.tab -i $PROJECT.I${INFLATION}.mcl.out -db goodProteins.fasta --pfam ../domains/Pfam
